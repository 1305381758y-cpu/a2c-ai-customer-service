...
export function strictFlowScriptLine(key: string, language: string, fallback = ""): string {
  const zh: Record<string, string> = {
    ...
    link_load_failure_handoff_ack: "我这边先帮您转人工核对注册链接，请稍等一下。",
  ...
  const en: Record<string, string> = {
    ...
    link_load_failure_handoff_ack: "I will pass this to a person to verify the registration link for you. Please wait a moment.",
  ...
  const pt: Record<string, string> = {
    ...
    link_load_failure_handoff_ack: "Vou encaminhar para uma pessoa verificar o link de cadastro para você. Aguarde um momento, por favor.",
  ...
  const es: Record<string, string> = {
    ...
    link_load_failure_handoff_ack: "Voy a pasar esto a una persona para revisar el enlace de registro. Espere un momento, por favor.",
