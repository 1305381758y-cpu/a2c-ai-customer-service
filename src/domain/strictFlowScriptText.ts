...
export function strictFlowScriptLine(key: string, language: string, fallback = ""): string {
  const zh: Record<string, string> = {
    ...
    telegram_purpose_after_phone_ack: "后续导师会通过 Telegram 为您提供任务指导。Telegram 准备好后，我会发送导师链接，由您主动联系导师。",
    telegram_optional_ack: "如果要继续当前流程，需要使用 Telegram 联系导师；我们不会要求您提供 Telegram 密码或验证码。",
    telegram_required_ack: "因为后续指导统一在 Telegram 进行。您准备好后，我可以继续教您下载安装。",
    ...
    ask_question_prompt: "当然可以，请直接说您的问题，我先回答您。",
    ask_question_prompt_tg: "当然可以，请直接说您的问题，我先回答您。",
    question_wait_ack: "好的。如果还有疑问可以继续问；准备继续当前步骤时，直接告诉我就可以。",
    customer_correction_ack: "能听懂，抱歉刚才推进得太快了。您是想先把问题问清楚，再决定是否继续；请直接说您的问题，我先停在这里。",
    ...
    telegram_verification_code_handoff_ack: "稍等，我向公司核实解决办法。",
    ...
    temporary_pause_ack: "好的，您先忙，方便时告诉我，我们再继续；现在先不发送注册链接。",
    temporary_pause_time_clarification_ack: "没有固定时间要求，您按自己方便的时间就可以。方便时告诉我，我们再继续；现在先不发送注册链接。",
    ...
    bridge_registration_intent: "您现在是否有空闲时间继续开户注册？",
    ...
    project_intro: "好的，我先简单介绍一下：这份兼职在线工作主要是协助商家提升产品销量和排名，按任务获得佣金。具体收益以页面规则和后续确认为准。",
    registration_intent: "要开始您的第一份工作并赚取佣金，您需要先在我们的平台上注册。您现在有空闲时间继续注册吗？我会一步一步教您完成。",
  ...
  const en: Record<string, string> = {
    ...
    telegram_purpose_after_phone_ack: "The mentor uses Telegram for the follow-up task guidance. Once Telegram is ready, I will send the mentor link so you can contact the mentor directly.",
    telegram_optional_ack: "To continue this process, Telegram is required to contact the mentor. We will not ask you for your Telegram password or verification code.",
    telegram_required_ack: "The follow-up guidance is handled through Telegram. When you are ready, I can guide you through downloading and installing it.",
    ...
    ask_question_prompt: "Of course. Tell me your question directly, and I will answer it first.",
    ask_question_prompt_tg: "Of course. Tell me your question directly, and I will answer it first.",
    question_wait_ack: "Okay. You can keep asking if anything is unclear. When you are ready to continue the current step, tell me directly.",
    customer_correction_ack: "I understand. Sorry, I moved too quickly. You want to ask your question before deciding whether to continue, so please tell me the question first. I will not continue the registration step yet.",
    ...
    telegram_verification_code_handoff_ack: "Please wait a moment while I check with the company for a solution.",
    ...
    temporary_pause_ack: "Okay, take your time. Let me know when you are free and we will continue; I will not send the registration link yet.",
    temporary_pause_time_clarification_ack: "There is no fixed time requirement. Continue whenever it suits you; let me know when you are free, and I will not send the registration link yet.",
    ...
    project_intro: "Okay, let me briefly introduce it: this online part-time work helps merchants improve product sales and ranking, and commission is based on tasks. The exact earnings follow the page rules and later confirmation.",
    registration_intent: "To start your first job and earn commission, you need to register on our platform first. Do you have time now to continue registration? I will guide you step by step.",
  ...
  const pt: Record<string, string> = {
    ...
    telegram_purpose_after_phone_ack: "A professora usa o Telegram para orientar as próximas tarefas. Quando o Telegram estiver pronto, vou enviar o link para você entrar em contato diretamente com ela.",
    telegram_optional_ack: "Para continuar este processo, é necessário usar o Telegram para falar com a professora. Não vamos pedir sua senha nem o código de verificação do Telegram.",
    telegram_required_ack: "As próximas orientações são feitas pelo Telegram. Quando estiver pronto, posso ensinar como baixar e instalar o aplicativo.",
    ...
    ask_question_prompt: "Claro, pode dizer sua pergunta diretamente. Vou responder primeiro.",
    ask_question_prompt_tg: "Claro, pode dizer sua pergunta diretamente. Vou responder primeiro.",
    question_wait_ack: "Certo. Se ainda tiver dúvidas, pode continuar perguntando. Quando quiser seguir com a etapa atual, diga diretamente.",
    customer_correction_ack: "Entendi. Desculpe, avancei rápido demais. Você quer esclarecer sua pergunta antes de decidir se continua; pode dizer a pergunta primeiro. Não vou avançar o cadastro agora.",
    ...
    telegram_verification_code_handoff_ack: "Aguarde um momento enquanto confirmo uma solução com a empresa.",
    ...
    temporary_pause_ack: "Tudo bem, cuide do que precisa agora. Quando estiver disponível, me avise e continuamos; ainda não vou enviar o link de cadastro.",
    temporary_pause_time_clarification_ack: "Não há um horário fixo. Pode continuar no horário que for melhor para você; quando estiver disponível, me avise. Ainda não vou enviar o link de cadastro.",
    ...
    project_intro: "Certo, vou explicar rapidamente: este trabalho online ajuda comerciantes a melhorar vendas e ranqueamento dos produtos, e a comissão depende das tarefas. Os ganhos exatos seguem as regras da página e a confirmação posterior.",
    registration_intent: "Para começar seu primeiro trabalho e ganhar comissão, você precisa se cadastrar primeiro na nossa plataforma. Você tem tempo agora para continuar o cadastro? Vou orientar você passo a passo.",
  ...
  const es: Record<string, string> = {
    ...
    telegram_purpose_after_phone_ack: "La profesora usa Telegram para darle la orientación de las siguientes tareas. Cuando Telegram esté listo, le enviaré el enlace para que usted la contacte directamente.",
    telegram_optional_ack: "Para continuar este proceso, necesita usar Telegram para contactar a la profesora. No le pediremos su contraseña ni el código de verificación de Telegram.",
    telegram_required_ack: "La orientación posterior se realiza por Telegram. Cuando esté listo, puedo enseñarle a descargar e instalar la aplicación.",
    ...
    ask_question_prompt: "Claro, dígame su pregunta directamente. Primero se la respondo.",
    ask_question_prompt_tg: "Claro, dígame su pregunta directamente. Primero se la respondo.",
    question_wait_ack: "De acuerdo. Si todavía tiene dudas, puede seguir preguntando. Cuando quiera continuar con el paso actual, dígamelo directamente.",
    customer_correction_ack: "Le entiendo. Disculpe, avancé demasiado rápido. Quiere aclarar su pregunta antes de decidir si continúa; dígame primero su pregunta. No avanzaré el registro ahora.",
    ...
    telegram_verification_code_handoff_ack: "Espere un momento mientras consulto con la empresa una solución.",
    ...
    temporary_pause_ack: "De acuerdo, tómese su tiempo. Cuando esté disponible, avíseme y continuamos; todavía no enviaré el enlace de registro.",
    temporary_pause_time_clarification_ack: "No hay un horario fijo. Puede continuar cuando le resulte conveniente; cuando esté disponible, avíseme. Todavía no enviaré el enlace de registro.",
    ...
    project_intro: "Claro, le explico brevemente: este trabajo en línea ayuda a comerciantes a mejorar ventas y posicionamiento de productos, y la comisión depende de las tareas. Las ganancias exactas siguen las reglas de la página y la confirmación posterior.",
    registration_intent: "Para empezar su primer trabajo y ganar comisión, primero debe registrarse en nuestra plataforma. ¿Tiene tiempo ahora para continuar con el registro? Le guío paso a paso.",
