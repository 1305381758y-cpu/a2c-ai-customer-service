...
intent 只能是：
phone_submission, telegram_submission, positive_confirmation, acknowledgement, negative_refusal, not_available, not_registered, no_telegram, telegram_installed, need_help, ask_platform_register, ask_link, ask_tg_register, platform_register_done, payment_concern, investment_concern, trust_concern, earning_concern, workflow_question, job_question, complaint, chat, sensitive_request, unknown_question, unknown
