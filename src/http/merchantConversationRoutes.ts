...
export function registerMerchantConversationRoutes(app: FastifyInstance, deps: MerchantConversationRoutesDeps): void {
  ...
  app.get<{ Querystring: { countryId?: string; status?: string; handoffStatus?: string; language?: string; a2cAccountPhone?: string; customerPhone?: string; startAt?: string; endAt?: string; timeZone?: string; limit?: string; offset?: string } }>("/api/merchant/conversations", { preHandler: deps.merchantRoles }, async (request) => ({
