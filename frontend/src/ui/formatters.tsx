...
export function label(key: string) {
  return ({
    ...
    limit: "数量", q: "关键词搜索", startAt: "开始时间", endAt: "结束时间", version: "版本", stepCount: "节点数", draft: "草稿", true: "启用", false: "停用", faq: "问答", script: "话术", rule: "规则", forbidden: "禁用表达", human_handoff: "已接管",
    ...
    totalCalls: "调用总数", successCalls: "成功", errorCalls: "失败", successRate: "成功率", averageDurationMs: "平均耗时ms", taskType: "调用类型", provider: "供应商", model: "模型", errorMessage: "失败原因", httpStatus: "状态码", responseSummary: "返回摘要", lastCalledAt: "最近调用时间", lastFailedAt: "最近失败时间",
