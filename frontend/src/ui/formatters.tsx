...
export function label(key: string) {
  return ({
    ...
    totalCalls: "调用总数", successCalls: "成功", errorCalls: "失败", successRate: "成功率", averageDurationMs: "平均耗时ms", taskType: "调用类型", provider: "供应商", model: "模型", errorMessage: "失败原因", lastCalledAt: "最近调用时间", lastFailedAt: "最近失败时间",
