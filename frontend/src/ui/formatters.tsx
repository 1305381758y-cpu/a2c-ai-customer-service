...
export function label(key: string) {
  return ({
    ...
    "save telegram and check handoff": "保存TG并检查接管", "guide telegram download": "引导下载TG", "guide telegram username setup": "引导设置TG用户名",
    "collect telegram username": "收集TG用户名", "help registration": "协助开户注册", "answer previous registration question": "回答上一个注册问题",
    "answer registration field question": "回答注册字段问题", "pause politely": "礼貌暂停", "wait for telegram username": "等待TG用户名",
